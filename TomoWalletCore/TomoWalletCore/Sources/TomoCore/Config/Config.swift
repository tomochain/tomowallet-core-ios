...
struct Constants {
    ...
    public static let images = "https://wallet.tomochain.com/public"
    public static let TomoAPI  =   URL(string:"https://wallet.tomochain.com/api")!
    ...
    public static let TOMOSCAN = "https://scan.tomochain.com"
